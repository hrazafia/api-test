...
async function detailAction(request, response)
{
	try
	{
...
async function updateAction(request, response)
{
	try
	{
		...
		const updateMovie = await save(movie, request.user.id);
...
export { listAction, detailAction, createAction, updateAction, deleteAction };
